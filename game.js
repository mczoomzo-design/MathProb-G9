...
extra.textContent = '.boss-banner{display:flex;flex-direction:column;gap:6px;background:#2a1650;color:#ffe6ff;border:3px solid var(--ink);border-radius:16px;padding:12px 16px;font-family:Kanit;font-weight:700;font-size:15px;box-shadow:var(--hard);transition:background .2s}.boss-banner.hit{background:#7a1846}.boss-hp-track{height:12px;background:#1a0d33;border:2px solid var(--ink);border-radius:8px;overflow:hidden}.boss-hp-fill{height:100%;background:linear-gradient(90deg,#ff6b6b,#ffd23f);transition:width .6s ease}.boss-card{border-color:var(--purple)!important}.pvp-hp-row{display:flex;align-items:center;gap:10px}.pvp-side{flex:1;display:flex;flex-direction:column;gap:4px}.pvp-name{font-family:Kanit;font-weight:700;font-size:14px}.pvp-hp-track{height:14px;background:#fff;border:3px solid var(--ink);border-radius:8px;overflow:hidden}.pvp-hp-fill{height:100%;background:linear-gradient(90deg,#ff6b6b,#ff9f43);transition:width .5s ease}.pvp-vs{font-family:Kanit;font-weight:800;color:var(--purple);font-size:16px}.turn-tag{font-family:Kanit;font-weight:700;font-size:15px;color:var(--purple)}';
